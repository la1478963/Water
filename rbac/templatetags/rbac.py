...
@register.inclusion_tag("get_button.html")
def get_button_html(data,item):
    ret=getattr(data,item[2])

    return {'ret':ret,'item':item}
...
def menu_html(request):
    ...
    """
    # menu_list = []
    # from rbac.service.init_permission-->mune_list
